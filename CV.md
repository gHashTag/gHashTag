...
> I take a novel number format from an arXiv paper to live FPGA hardware (Artix-7) — and make the neural network **train itself** on the FPGA. Math → formal spec → RTL → FPGA → on-device ML → machine-checked proof. Solo, on a fully open-source flow.
...
- **TinyTapeout SKY130 design** — GDS ✅ · gate-level test ✅ · precheck ✅; submissions TTSKY26a (withdrawn and refunded, 6 Aug 2026) and TTSKY26b (withdrawn before fabrication) — no die exists; all hardware results are on the Artix-7 (XC7A200T) FPGA prototype.
...
**Zenodo DOIs:** [GoldenFloat: φ-Optimal Floating-Point Formats for Ternary Computing (T27)](https://doi.org/10.5281/zenodo.19456875) · [Trinity S³AI Framework — Complete Research Collection v5.0](https://doi.org/10.5281/zenodo.19227879) · [Trinity v2.0.2 — FPGA Autoregressive Ternary LLM](https://doi.org/10.5281/zenodo.18947017)
...
| Period | Role |
|---|---|
| 2026 – now | **FPGA / ML Research Engineer** — GF16 matmul on Artix-7, TinyTapeout design (withdrawn before fabrication), `trinity-fpga`, on-device training |
...
Systems       Rust · Zig · Coq/Rocq · LaTeX · ternary logic · spec→FPGA
